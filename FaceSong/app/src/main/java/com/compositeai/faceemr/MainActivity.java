...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spotifyPlay = (Button) findViewById(R.id.spotifyButton);
        spotifyPlay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openSpotify();
            }
    ...
    private void detectEmotion(){
        ...
        songText.setText("Recommended Song: "+song);
    }
    ...
    private void clearStatus(){
        ...
        this.songText.setText("Recommended Song:");
